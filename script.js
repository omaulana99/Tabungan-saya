    ...
    li.innerHTML = `
      ...
      <div id="details-${index}" style="display: ${isDetailVisible ? 'block' : 'none'}; margin-top: 10px;">
        ...
        ${saving.targetTabungan ? `
          <strong>Persentase Pencapaian:</strong> ${persenPencapaian}%<br>
          <strong>Status Tabungan:</strong> ${persenPencapaian < 100 ? "Kurang dari target tabungan" : "Terkumpul penuh"}<br>
        ` : ''}
